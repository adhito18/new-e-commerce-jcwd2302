        ...
        <div className="flex flex-col items-center">
            ...
            <div className="mt-8 flex flex-col items-center w-2/6 self-center my-bg-light drop-shadow-lg rounded-xl">
                ...
                <div className="self-start ml-20 text-lg mb-5">
                    ...
                    <label className="ml-2 text-md text-gray-900 dark:text-gray-300 items-center">Keep me signed in. <span className="my-main font-bold underline hover:no-underline ">Details</span></label>
                </div>
                ...
                <div className="mt-10 self-end mr-10 ">
                    <button onClick={() => props.myFunc1.onLoginWithGoogle()} className="my-bg-main px-7 py-3 rounded-full my-light text-xl mb-10 drop-shadow-lg font-bold"> Login with google</button>
